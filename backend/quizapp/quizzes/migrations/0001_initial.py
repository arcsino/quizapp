...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('question', models.JSONField(error_messages={'blank': 'This field cannot be blank.'}, help_text='The question content in JSON format.', verbose_name='Question')),
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='Creation timestamp.', verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Last update timestamp.', verbose_name='Updated At')),
                ...
                ('tags', models.ManyToManyField(help_text='Tags associated with the quiz.', related_name='quizzes', to='quizzes.tag', verbose_name='Tags')),
            ],
        ),
    ]
